            ...
            <div className={classes.item}>            
                <form className={classes.form} onSubmit={submitHandler}>
                    ...
                    <div className={classes.control}>
                        ...
                        <input type="text" required id="alias" placeholder='enter your alias name' ref={aliasInputRef}/>
                    </div>
                    <div className={classes.control}>
                        <label htmlFor="image">Renew Years</label>
                        <input type="number" required id="renewYear" placeholder='enter renew years' min="1" max="10" ref={renewYearInputRef}/>
                    </div>
